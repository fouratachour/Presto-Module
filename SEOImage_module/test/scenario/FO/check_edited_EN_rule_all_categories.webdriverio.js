...
describe('Verify the edited rule applied to all categories when the shop is in english', function(){
    ...
    describe('Verify the edited rule in all categories when the shop is in english', function(done){
