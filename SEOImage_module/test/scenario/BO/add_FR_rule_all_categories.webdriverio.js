...
describe('Add rule in all categories when the front is in french ', function(){
    ...
    describe('The configuration of the module', function(done) {
        ...
        it('should add the rule name', function(done) {
            ...
            this.client
                ...
                .setValue(this.selector.BO.ModuleConfiguration.rule_name, 'testFR1')
                .call(done);
        });
        ...
        it('should write the rule condition', function(done){
            ...
            this.client
                ...
                .pause(5000)
                .setValue(this.selector.BO.ModuleConfiguration.rules_condition,'{product_name}{product_reference} FR1')
                .call(done);
        });
