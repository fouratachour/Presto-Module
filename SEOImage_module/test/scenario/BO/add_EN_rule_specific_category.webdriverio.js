...
describe('Add rule in a specific category when the front is in english ', function(){
    ...
    describe('The configuration of the module', function(done) {
        ...
        it('should add the rule name', function(done) {
            ...
            this.client
                ...
                .setValue(this.selector.BO.ModuleConfiguration.rule_name, 'testEN2')
                .call(done);
        });
        ...
        it('should write the rule condition', function(done){
            ...
            this.client
                ...
                .pause(5000)
                .setValue(this.selector.BO.ModuleConfiguration.rules_condition,'{product_price_wt}{product_reduce_price_wt}{product_reduction_percent} EN2')
                .call(done);
        });
        ...
        it('should click on apply all rules ', function(done){
            ...
            this.client
                .pause(5000)
                .waitForExist(this.selector.BO.ModuleConfiguration.apply_rule2_btn, 90000)
                .click(this.selector.BO.ModuleConfiguration.apply_rule2_btn)
                .pause(5000)
                .call(done);
        });
    });
