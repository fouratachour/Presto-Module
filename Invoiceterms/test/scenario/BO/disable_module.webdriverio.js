...
describe('Test case n°1 = Check the default configuration', function(){
	...
	after(common.after);
		...
		describe('Check the default configuration in BO', function(done){
            ...
            it('should go to the module and disable', function (done) {
                if (global.nbr === 0) {
                    ...
                    this.client
                        ...
                        .waitForVisible('//*[@id="module-modal-confirm-ps_invoiceterms-disable"]/div/div/div[3]/a', 90000)
                        .click('//*[@id="module-modal-confirm-ps_invoiceterms-disable"]/div/div/div[3]/a')
